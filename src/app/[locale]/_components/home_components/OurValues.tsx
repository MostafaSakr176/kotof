...
import ourValuesimg from '@/media/our values img1.png'
  ...
  return (
    ...
    <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
      <div data-aos="fade-right" data-aos-duration="500" data-aos-delay="0" className={'rounded-[20px] flex flex-col items-center justify-center gap-8 p-12 bg-gradient-to-b from-[#47c58232] to-[#00944400]'}>
        <Image src={data? data[0]?.image  : ourValuesimg} width={100} height={100}className='w-full h-auto' alt='our values' />
      ...
      <Image src={data? data[1]?.image  : ourValuesimg} width={100} height={100}className='w-full h-auto' alt='our values' />
      ...
      <Image src={data? data[2]?.image  : ourValuesimg} width={100} height={100}className='w-full h-auto' alt='our values' />
